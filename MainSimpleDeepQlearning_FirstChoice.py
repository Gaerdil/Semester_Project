...
for item in environnement.items.items :
    item.cost = 1
environnement.items.items[6].cost =0
...
#
#
#Works well (maybe better without the sigmoid layer). No more memory crashing. But very very long for loops trough the actions...